...
from models import UserInfo, RoleList, PermissionList, UserGroup, RoleJob
...
class AddUserForm(forms.ModelForm):
    class Meta:
        model = UserInfo
        fields = ('username', 'password', 'email', 'nickname', 'type', 'role', 'is_active','role_job')
        widgets = {
...
class EditUserForm(forms.ModelForm):
    class Meta:
        model = UserInfo
        fields = ('username', 'email', 'nickname', 'type', 'role', 'is_active','role_job')
        widgets = {
